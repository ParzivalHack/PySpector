...
try:
    from pyspector.plugin_system import PluginMetadata, PySpectorPlugin
except ImportError:
    # Fallback for standalone testing
    from plugin_system import PluginMetadata, PySpectorPlugin
...
class GroqPoCGeneratorPlugin(PySpectorPlugin):
    ...
    def process_findings(
        ...
        # Filter by severity
        filtered = [f for f in findings if f.get("severity", "").upper() in self.severity_filter]
