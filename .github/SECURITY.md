...
- PySpector's Plugin Sandbox is now explicitly **out of scope**. Because of hard-to-patch classes of vulnerabilities and low community use of this feature, the whole plugin system will be removed entirely from the PySpector codebase in the next incoming release (v0.2.1).
